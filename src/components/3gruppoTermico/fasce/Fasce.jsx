      ...
      <div className="wrapper">
        ...
        >
          <div className="titleColumn">
            ...
            <motion.p className="lead" variants={fadeUpVariants}>
              ...
              sono gli elementi che separano la camera di combustione dal carter.
              Alloggiate nelle scanalature ricavate nel pistone, hanno il compito
              di mantenere la tenuta dei gas combusti verso l'alto, di trasferire
              il calore dalla testa del pistone alla camicia e di impedire
              che l'olio miscelato risalga verso la camera in quantità eccessiva.
              In un motore a 2 tempi, dove tutto accade in una singola rotazione
              dell'albero, anche una minima perdita di tenuta si traduce
              immediatamente in calo di compressione e perdita di potenza.
            </motion.p>
            ...
            <motion.p variants={fadeUpVariants}>
              ...
              della fascia raschiaolio è una conseguenza diretta del sistema
              di lubrificazione a miscela: l'olio fa parte della carica stessa
              e non deve essere raschiato dalla camicia nel senso tradizionale.
            </motion.p>
          </div>
          ...
          <motion.div className="infoPanel" variants={fadeUpVariants}>
            ...
            <div className="flowStepsMini">
              <div className="miniStep">
                ...
                <span className="miniText">Tenuta gas — impediscono ai gas combusti di scendere nel carter</span>
              </div>
              <div className="miniStep">
                <span className="miniIndex">02</span>
                <span className="miniText">Trasferimento termico — conducono il calore dal pistone alla camicia</span>
              </div>
              <div className="miniStep">
                <span className="miniIndex">03</span>
                <span className="miniText">Centraggio — contribuiscono a guidare il pistone nella camicia</span>
              </div>
              <div className="miniStep">
                <span className="miniIndex">04</span>
                <span className="miniText">Controllo olio — limitano il film lubrificante sulla parete</span>
              </div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="mediaPlaceholder">
            <div className="placeholderInner">
              ...
              <span className="placeholderText">Immagine / GIF — fascia elastica sul pistone 2T</span>
          ...
          <div className="visualCaption">
            ...
            <p>
              ...
              creando una tenuta dinamica che si autoregola con la pressione
              dei gas combusti durante la fase di combustione.
            </p>
          </div>
        </motion.div>
          ...
          <motion.div className="flowDiagram" variants={cardVariants}>
            ...
            <div className="diagramNode">
              ...
              <p>
                ...
                basso della scanalatura e radialmente verso la camicia. Più
                alta è la pressione in camera, più forte è la tenuta: il sistema
                è autoregolandosi per definizione.
              </p>
            </div>
            ...
            <div className="diagramNode">
              ...
              <p>
                ...
                del calore asportato dalla testa del pistone passi attraverso
                le fasce verso la camicia e quindi verso il sistema di
            ...
            <div className="diagramNode">
              ...
              <p>
                ...
                del tutto per usura della fascia o cedimento termico, i lembi
                si toccano e la fascia si rompe.
              </p>
            </div>
        ...
        >
          <motion.div className="materialiHeader" variants={fadeUpVariants}>
            ...
            <p>
              ...
              parete della camicia, l'attrito durante lo scorrimento e la
              durata nel tempo. Non esiste un materiale universale: ogni
              applicazione ha le sue priorità.
            </p>
          </motion.div>
          ...
          <motion.div className="materialiGrid" variants={cardVariants}>
            ...
            <div className="matCard">
              ...
              <p>
                ...
                con benefici diretti sulla riduzione delle masse oscillanti
                e sull'attrito. Sono lo standard nelle applicazioni sportive
                e racing moderne.
              </p>
            </div>
            ...
            <div className="matCard">
              ...
              <p>
                ...
                (Diamond-Like Carbon) sono la frontiera attuale per le fasce
                da competizione. Strati sottilissimi — nell'ordine del micron —
                che abbinano durezza superficiale estrema a coefficienti di
                attrito bassissimi. Rodaggio rapido, usura minima, tenuta
                ottimale anche con giochi ridotti. Costo elevato, esclusivo
                uso racing e motori premium.
              </p>
            </div>
        ...
        >
          <div className="visualCaption">
            ...
            <p>
              Sezione trasversale della fascia nella sede del pistone: la
              forma rettangolare standard, il gioco assiale nella scanalatura,
              il giunto di apertura e il profilo barrel-face sulla superficie
              di contatto con la camicia che favorisce la formazione del film
              lubrificante.
            </p>
          </div>
          {/* ↓↓↓ INSERISCI QUI LA TUA IMG O GIF ↓↓↓ */}
          <div className="mediaPlaceholder">
            <div className="placeholderInner">
              <span className="placeholderIcon">⊕</span>
              <span className="placeholderText">Immagine / GIF — sezione fascia in sede e giunto</span>
              <span className="placeholderSub">Sostituisci questo div con &lt;img&gt; o &lt;video&gt;</span>
            </div>
          </div>
          {/* ↑↑↑ FINE PLACEHOLDER ↑↑↑ */}
        ...
        >
          ...
          <motion.div className="geometriaGrid" variants={cardVariants}>
            ...
            <div className="geoCard">
              ...
              <p>
                Il profilo più comune e semplice. Superficie di contatto
                ampia, buona tenuta dei gas, rodaggio relativamente lento.
                Usato nella maggior parte dei motori stradali e da enduro
                come fascia superiore. Il profilo piatto richiede una camicia
                ben rettificata per funzionare al meglio.
              </p>
            </div>
            ...
            <div className="geoCard">
              ...
              <p>
                La superficie esterna è leggermente convessa — a botte.
                Questo profilo favorisce la formazione del cuneo di olio
                durante la corsa del pistone, riducendo l'attrito e
                migliorando la lubrificazione. Tollera meglio le
                imperfezioni di allineamento biella-pistone e il
                cedimento termico della camicia.
              </p>
            </div>
            ...
            <div className="geoCard">
              ...
              <p>
                La superficie di contatto è leggermente inclinata, con
                il bordo inferiore che sporge più del superiore. Nella
                corsa di discesa del pistone il profilo conico agisce
                da raschia, riportando il film di olio verso il basso.
                Usato come seconda fascia in abbinamento alla prima
                rettangolare o barrel.
              </p>
            </div>
            ...
            <div className="geoCard">
              ...
              <p>
                ...
                baionetta. Il giunto dritto è il più semplice e diffuso;
                i giunti complessi riducono il passaggio diretto di gas
                attraverso l'apertura aumentando la tenuta, al costo
                di una maggiore complessità produttiva e di montaggio.
              </p>
            </div>
        ...
        >
          <motion.div className="quoteHeader" variants={fadeUpVariants}>
            ...
            <p>
              ...
              dell'olio. Ogni valore va verificato con strumenti adeguati
              prima del montaggio.
            </p>
          </motion.div>
          ...
          <motion.div className="quoteGrid" variants={cardVariants}>
            ...
            <div className="quoteCard">
              ...
              <p>
                ...
                non chiuda completamente e si rompa; il massimo garantisce
                che la tenuta sia sufficiente.
              </p>
            </div>
            ...
            <div className="quoteCard">
              ...
              <p>
                ...
                l'espansione termica; troppo largo permette oscillazioni
                assiali che danneggiano sia la fascia che le pareti della
                sede e causano pompaggio dell'olio.
              </p>
            </div>
            ...
            <div className="quoteCard">
              ...
              <p>
                ...
                pressione dei gas di agire sul retro della fascia per
                creare la tenuta autoregolante, ma non deve essere eccessivo
                per evitare vibrazioni della fascia nella sede.
              </p>
            </div>
        ...
        >
          <motion.div className="usuraHeader" variants={fadeUpVariants}>
            ...
            <p>
              ...
              delle fasce. Molti segnali emergono dall'analisi delle prestazioni,
              dal comportamento del motore e da una misura di compressione. La
              diagnosi precoce evita di ritrovarsi a smontare il motore in
          ...
          <motion.div className="usuraGrid" variants={cardVariants}>
            ...
            <div className="usuraCard">
              ...
              <p>
                ...
                specifica del motore. Valori inferiori al 20 – 30% rispetto
                al nuovo indicano fasce da sostituire. La misura va eseguita
                con il motore caldo e il getto del gas spalancato.
              </p>
            </div>
            ...
            <div className="usuraCard">
              ...
              <p>
                In un 2T il fumo bianco-azzurro allo scarico è normale in
                misura ridotta per via dell'olio in miscela. Un fumo blu
                persistente e intenso — specialmente in rilascio o alla
                ripresa — indica che le fasce non trattengono più l'olio
                sulla parete della camicia, che risale in camera in quantità
                eccessiva.
              </p>
            </div>
            ...
            <div className="usuraCard">
              ...
              <p>
                ...
                l'avviamento, rendendo necessari più colci con il kick o
                più tentativi col motorino. A motore avviato il minimo può
                risultare instabile o richiedere un numero di giri più alto
                per mantenersi regolare.
              </p>
            </div>
            ...
            <div className="usuraCard">
              ...
              <p>
                Se la misura di compressione è bassa, si aggiungono 2 – 3 cm³
                di olio nel cilindro attraverso il foro della candela e si
                ripete la misura. Se la compressione sale significativamente,
                il problema è nelle fasce. Se rimane invariata, il problema
                è nella testa o nella valvola di scarico (nei motori con
                scarico variabile).
              </p>
            </div>
            ...
            <div className="usuraCard">
              ...
              <p>
                ...
                superficie di contatto, depositi duri nella sede che bloccano
                il movimento, rotture o scheggiature. Una fascia integra
                deve scorrere liberamente nella sua sede e non presentare
            ...
            <div className="usuraCard">
              ...
              <p>
                ...
                pistone ogni 15 – 25 ore. In uso amatoriale intenso ogni
                40 – 60 ore o a ogni misura di compressione che scenda
                sotto il 90% del valore di specifica. In uso stradale
                moderato la vita può superare le 100 ore se la miscela
                è corretta e il rodaggio è stato rispettato.
              </p>
            </div>
        ...
        >
          ...
          <div className="mediaPlaceholder">
            <div className="placeholderInner">
              <span className="placeholderIcon">⊕</span>
              <span className="placeholderText">Immagine / GIF — misura giunto fascia con spessimetro</span>
              <span className="placeholderSub">Sostituisci questo div con &lt;img&gt; o &lt;video&gt;</span>
            </div>
          </div>
          {/* ↑↑↑ FINE PLACEHOLDER ↑↑↑ */}
          <div className="visualCaption">
            ...
            <p>
              Misurazione del giunto di apertura con spessimetro laminare:
              la fascia viene inserita nel cilindro alla quota operativa e
              il gioco al giunto viene misurato con precisione decimillesimale.
              È una delle misure più importanti nell'assemblaggio del gruppo
              termico.
            </p>
          </div>
        </motion.div>
        ...
        >
          <motion.article className="infoCard" variants={cardVariants}>
            ...
            <p>
              ...
              arresto (pin) che entra nel giunto della fascia e ne impedisce
              la rotazione. Il montaggio va eseguito verificando che il pin
              sia perfettamente allineato col giunto.
            </p>
          </motion.article>
          ...
          <motion.article className="infoCard" variants={cardVariants}>
            ...
            <p>
              ...
              superficie di contatto si adatta progressivamente durante
              le prime ore di esercizio. In questa fase l'attrito è
              maggiore, le temperature più alte e la tenuta non è ancora
              al massimo. Il rispetto del protocollo di rodaggio — cicli
              brevi con raffreddamenti completi — è fondamentale per
              estendere la vita della fascia e del cilindro.
            </p>
          </motion.article>
          ...
          <motion.article className="infoCard" variants={cardVariants}>
            ...
            <p>
              ...
              Acquistare la fascia separatamente è possibile ma richiede
              di verificare la compatibilità dimensionale esatta con il
              pistone in uso. Su motori preparati con cilindro nikasil
              o alusil, le fasce vanno scelte specificamente per questo
