import "./twoStrokeVsFourStroke2.scss";
...
const TwoStrokeVsFourStroke2 = () => {
  ...
  return (
    <section className="twoStrokeVsFourStroke2" id="2t-vs-4t">
...
export default TwoStrokeVsFourStroke2;